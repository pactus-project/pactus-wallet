                        ...
                        <div className="sidebar__account-list">
                            {getAccountList()?.map((item, i) => (
                                <button 
                                    ...
                                    key={`${i}-account`}
                                    aria-current={isActiveRoute(`/wallet?address=${item?.address}`) ? 'page' : undefined}
                                >
            ...
            <div className="sidebar__footer">
                ...
                <div id="contributing-parent" className="sidebar__contributing">
                    ...
                    <div className="sidebar__contributing-content">
                        ...
                        <p className="sidebar__contributing-description">You can contribute to the Pactus wallet project at any time.</p>
                        <a 
