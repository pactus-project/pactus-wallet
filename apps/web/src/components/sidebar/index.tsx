    ...
    <div className="sidebarContainer">
        ...
        <div>
          ...
          <div className="accountItems-sidebar">
            {getAccountList()?.map((item, i) => (
              <button
                style={{
                  background: isActiveRoute(`/wallet?address=${item?.address}`)
                    ? '#15191C'
                    : 'none',
                }}
      ...
      <button
        className={`route-sidebar ${
          isActiveRoute('/frequently-asked-questions') ? 'activeRoute-sidebar' : ''
        }`}
      >
      ...
      <div id="contributing-parent" className="Contributing-sidebar">
        ...
        <div>
          ...
          <button>
            Join
            <Image src={gradientArrowToRightIcon} alt="gradientArrowToRightIcon" />{' '}
          </button>
        </div>
        <BorderBeam
          duration={4}
